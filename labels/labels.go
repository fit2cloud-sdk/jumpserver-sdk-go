...
func (s *Service) Update(ctx context.Context, id string, req *model.LabelRequest) (*model.Label, *core.Response, error) {
	return util.Update[model.Label, model.LabelRequest](ctx, s.client, DetailURL, id, req)
}
